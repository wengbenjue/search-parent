 ...
 *         pages.
 */
private[search] abstract class WebView(
                                         port: Int,
                                         conf: SolrClientConf,
                                         basePath: String = "",
                                         name: String = "")
  extends Logging with Configuration{

  protected val handlers = ArrayBuffer[ServletContextHandler]()
  protected val pageToHandlers = new HashMap[WebViewPage, ArrayBuffer[ServletContextHandler]]
  protected var serverInfo: Option[ServerInfo] = None
  protected val publicHostName = monitorHost
 ...
 */
private[search] abstract class WebViewPage(var prefix: String) {
